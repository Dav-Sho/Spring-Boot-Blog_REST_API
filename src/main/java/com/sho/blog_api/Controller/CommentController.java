...
//    Create comment
    ...
    private ResponseEntity<CommentDto> createComment(@RequestBody CommentDto commentDto, @PathVariable(value = "post_id") long post_id) {
    ...
    private ResponseEntity<CommentDto> updateCommentById(@RequestBody CommentDto commentDto, @PathVariable(value = "post_id") long postId, @PathVariable(value = "id") long commentId) {
